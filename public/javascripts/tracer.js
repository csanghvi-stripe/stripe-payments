class Tracer {
  ...
  static async TraceStripe(stripe) {
    ...
    stripe.handleCardSetup = tracer.watchAction({
      actionFunction: stripe.handleCardSetup,
      name: 'handleCardSetup',
      metadata: {
        description:
          'Stripe.js handles 3DS authentication of of a SetupIntent, if required. After this step the SetupIntent should be confirmed and the PaymentMethod should be attached to a Customer.',
        docUrl:
          'https://stripe.com/docs/stripe-js/reference#stripe-create-payment-method',
      },
      options: {
